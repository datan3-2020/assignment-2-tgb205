...
# use h_sex rather than h_esex as it has changed 
...
```
The table shows that Pakistani couples have the highest average number of children in this sample with a mean of 1.79 children per couple. White British couples have the lowest number of children with only 0.58. The result has excluded non-responses that may have skewed it but sample bias could affect the results. 
